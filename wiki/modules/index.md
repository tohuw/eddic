...
| [recorder](recorder.md) | the campaign's own recording bot: react-gated per-mic consent (fail-closed public consent post, role ping set via `/record consent-role`), DAVE receive via davey + pinned patches, and a localhost control surface | 0.2.2 |
