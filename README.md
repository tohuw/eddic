...
Eddic is licensed under Apache-2.0 (see `LICENSE`). Much of its code
and documentation was generated by AI agents under human direction;
copyright is claimed only to the extent human authorship exists — in
the selection, arrangement, and direction of the work and in
human-authored contributions. The license's permission grants apply to
whatever rights exist; its warranty disclaimer, liability terms, and
contribution terms (§5) apply regardless. Campaign content produced
with Eddic belongs to its authors and is untouched by this license.
Not legal advice.
